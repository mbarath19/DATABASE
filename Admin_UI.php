...
<body>
    ...
    <div id="tm-wrap">
        <div class="tm-main-content">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-md-col-xl-6 mb-md-0 mb-sm-4 mb-4 tm-site-header-col">
                        <div class="tm-site-header">
                            <h1 class="mb-4" style="font-family: 'Times New Roman', Times, serif; color: black;">Corp Wings Admin'S</h1>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="content">
                            <div class="grid">
                                <div class="grid__item" id="home-link">
                                    <div class="product">
                                        <div class="tm-nav-link">
                                            <a class=cards href="http://corpwings.netlify.app/">
                                            <img src="img/Cw.png">
                                            <span class="tm-nav-text" style="color: white;">Corp Wings</span></a>
                                            <!--<div class="product__bg"></div>        
                                        </div>                                   
                                        <div class="product__description">-->
                                           <!---<div class="row mb-3">
                                                <div class="col-12">
                                                    <h2 class="tm-page-title">Our Website</h2>        
                                                </div>
                                            </div>-->                                      
                                            <!---<div class="row">
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <div class="grid__item" id="home-link">
                                    <div class="product"><a href="https://seeweads.netlify.app/">
                                        <div class="tm-nav-link">
                                            <img src="img/logo001.png">
                                            <span class="tm-nav-text">SeeWe Ads</span>
                                        <!--<div class="product__bg"></div>        
                                        </div>                                    
                                        <div class="product__description">
                                            <div class="row mb-3">
                                ...
                                <div class="grid__item" id="home-link">
                                    <div class="product"><a href="https://www.canva.com/">
                                        <div class="tm-nav-link">
                                            <img  style="width:80px; height: 80px; margin-left:45px; margin-bottom: 15px;" src="img/c.jpg">
                                            <span class="tm-nav-text">Canva</span>
                                            <!--<div class="product__bg"></div>        
                                        </div>                                    
                                        <div class="product__description">
                                            <div class="row mb-3">
                                ...
                                <div class="grid__item" id="home-link">
                                    <div class="product"><a href="https://khatabook.com/">
                                        <div class="tm-nav-link">
                                            <img src="img/icon-khata.jpg" style="width:80px; height: 80px; margin-left:45px; margin-bottom: 15px;">
                                            <span class="tm-nav-text">KhataBook</span>
                                            <!--<div class="product__bg"></div>        
                                        </div>                                    
                                        <div class="product__description">
                                            <div class="row mb-3">
                                ...
                                <div class="grid__item" id="home-link">
                                    <div class="product"><a href="https://www.microsoft.com/en-us/microsoft-teams/log-in">
                                        <div class="tm-nav-link">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Microsoft_Office_Teams_%282018%E2%80%93present%29.svg/2203px-Microsoft_Office_Teams_%282018%E2%80%93present%29.svg.png" style="width:80px; height: 80px; margin-left:45px; margin-bottom: 15px;">
                                            <span class="tm-nav-text">Microsoft Teams</span>
                                           <!-- <div class="product__bg"></div>        
                                        </div>                                    
                                        <div class="product__description">
                                            <div class="row mb-3">
                                ...
                                <div class="grid__item" id="home-link">
                                    <div class="product"><a href="https://calendar.google.com/calendar/u/0/r?pli=1">
                                        <div class="tm-nav-link">
                                            <img src="img/calendar.jpg" style="width:80px; height: 80px; margin-left:45px; margin-bottom: 15px;">
                                            <span class="tm-nav-text">Google Calendar</span>
                                            <!--<div class="product__bg"></div>        
                                        </div>                                    
                                        <div class="product__description">
                                            <div class="row mb-3">
                                ...
                                <div class="grid__item" id="home-link">
                                    <div class="product"><a href="https://keep.google.com/">
                                        <div class="tm-nav-link">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Google_Keep_icon_%282015-2020%29.svg/2048px-Google_Keep_icon_%282015-2020%29.svg.png" style="width:80px; height: 80px; margin-left:45px; margin-bottom: 15px;">
                                            <span class="tm-nav-text">Google Keep</span>
                                            <!--<div class="product__bg"></div>        
                                        </div>                                    
                                        <div class="product__description">
                                            <div class="row mb-3">
                                ...
                                <div class="grid__item" id="team-link">
                                    <div class="product"><a href="https://www.google.co.in/alerts">
                                        <div class="tm-nav-link">
                                            <img src="img/icons8-google-alerts-480.png" style="width:80px; height: 80px; margin-left:45px; margin-bottom: 15px;">
                                            <span class="tm-nav-text">Google Alert</span>
                                            <!--<div class="product__bg"></div>            
                                        </div>                                     
                                        <div class="product__description">
                                            <div class="p-sm-4 p-2">
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                                        <h2 class="tm-page-title">Website of SeeWe Ads</h2>        
                                                    </div>
                                                </div>
                                ...
                                <div class="grid__item">
                                    <div class="product"><a href="https://mega.nz/login">
                                        <div class="tm-nav-link">
                                            <img src="https://cdn.worldvectorlogo.com/logos/mega-icon.svg" style="width:80px; height: 80px; margin-left:45px; margin-bottom: 15px;">
                                            <span class="tm-nav-text">Mega</span>
                                            <!--<div class="product__bg"></div>             
                                        </div>                                                                 
                                        <div class="product__description">
                                            <div class="p-sm-4 p-2">
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                                        <h2 class="tm-page-title">Mega Cloud Storage</h2>        
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                ...
                                <div class="grid__item">
                                    <div class="product"><a href="https://docs.google.com/spreadsheets/d/158TfxBj3OiUey3NyyEvmFuM6YMWFnRoX90Zh5e5KHo0/edit#gid=0">
                                        <div class="tm-nav-link">
                                            <img src="https://www.insidehighered.com/sites/default/files/media/GettyImages-1198430065.jpg" style="width:80px; height: 80px; margin-left:45px; margin-bottom: 15px;">
                                            <span class="tm-nav-text">Attendence</span>
                                           <!-- <div class="product__bg"></div>             
                                        </div>                                                              
                                        <div class="product__description">
            ...
            <footer>
                <p class="small tm-copyright-text">Copyright &copy; <span class="tm-current-year">2024</span> Corp Wings. 
